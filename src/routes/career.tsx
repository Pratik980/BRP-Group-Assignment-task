...
export const Route = createFileRoute("/career")({
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "Submit your application to join BRP Group's premier diversified venture ecosystem. Upload your CV and contact details to get in touch with our recruitment team.",
      },
      { property: "og:title", content: "BRP Group — Join Our Team" },
      {
        property: "og:description",
        content: "Join an innovative, fast-growing ecosystem of ventures in Nepal. Submit your general application today.",
      },
    ],
  }),
  ...
  return (
    <main className="relative min-h-screen overflow-x-hidden bg-background text-foreground">
      ...
      <section className="relative overflow-hidden bg-gradient-to-b from-secondary/50 via-background to-background pt-32 pb-10 md:pb-12">
        ...
        >
          We are always looking for talented individuals to join our growing ecosystem of ventures across Nepal. 
          Fill out the application form below and our recruitment team will get back to you.
        </motion.p>
        </div>
      </section>
          ...
          <AnimatePresence mode="wait">
            {submitSuccess ? (
              ...
              >
                ...
                <h3 className="text-2xl font-bold font-display text-foreground">Application Submitted</h3>
                <p className="mt-3 text-sm text-muted-foreground leading-relaxed">
                  Thank you for your interest in joining BRP Group, <span className="font-semibold text-foreground">{fullName}</span>. 
                  We have successfully received your details and resume. Our recruitment team will review your profile and contact you if it aligns with our requirements.
                </p>
                <button
