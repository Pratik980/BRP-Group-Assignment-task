    ...
    <>
      <header className="fixed top-4 left-1/2 -translate-x-1/2 z-50 w-[min(1180px,calc(100%-2rem))]">
        ...
        >
          ...
          >
            <img src={logo} alt="BRP Group" className="h-10 md:h-12 w-auto object-contain" />
          </Link>
          ...
          <div className="flex items-center gap-3">
            ...
            <button
              ...
              className="md:hidden flex items-center justify-center h-10 w-10 rounded-full bg-foreground/5 hover:bg-foreground/10 transition-colors"
