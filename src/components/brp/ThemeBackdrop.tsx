    ...
    >
      {variant === "hero" && (
        <>
          ...
          <div className="absolute -left-16 top-20 h-80 w-80 rounded-full bg-gradient-to-tr from-primary/10 to-accent/15 blur-3xl animate-pulse-glow" />
          <div className="absolute -right-20 top-32 h-96 w-96 rounded-full bg-gradient-to-br from-indigo-500/10 to-sky-500/10 blur-3xl" />
      ...
      {variant === "section" && (
        <>
          ...
          <div className="absolute -bottom-24 left-1/4 h-72 w-72 rounded-full bg-primary/8 blur-3xl" />
          <div className="absolute top-12 right-1/4 h-64 w-64 rounded-full bg-accent/10 blur-3xl" />
        </>
      )}
      ...
      {variant === "subtle" && (
        <>
          ...
          <div className="absolute -left-10 bottom-0 h-48 w-48 rounded-full bg-primary/6 blur-3xl" />
          <div className="absolute -right-10 top-10 h-56 w-56 rounded-full bg-accent/8 blur-3xl" />
        </>
      )}
      ...
      {variant === "page" && (
        <>
          ...
          <div className="absolute -left-24 top-32 h-96 w-96 rounded-full bg-primary/6 blur-3xl" />
          <div className="absolute -right-24 top-64 h-80 w-80 rounded-full bg-accent/8 blur-3xl" />
        </>
      )}
    </div>
  );
