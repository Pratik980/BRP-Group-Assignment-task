  ...
  return (
    <section id="values" className="relative py-32">
      ...
      <div className="relative mx-auto max-w-7xl px-6">
        ...
        <div className="mt-20 grid gap-5 md:grid-cols-6">
          {values.map((v, i) => {
            const Icon = v.icon;
            ...
            return (
              <motion.div
                ...
                className={`group relative overflow-hidden rounded-3xl shadow-glass transition-all duration-500 hover:shadow-float ${span}`}
              ...
              >
                ...
                <div className="relative z-10 flex flex-col h-full justify-between p-8">
                  ...
                  {/* Hover-reveal detail text */}
                  <div className="mt-4 overflow-hidden max-h-0 opacity-0 group-hover:max-h-40 group-hover:opacity-100 transition-all duration-500 ease-in-out">
