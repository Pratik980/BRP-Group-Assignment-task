...
export function ScrollTickers() {
  ...
  return (
    <section
      ref={containerRef}
      className="relative z-10 overflow-hidden border-y border-border/25 bg-background py-20 md:py-28"
      aria-label="BRP legacy highlights"
    >
      ...
      <motion.div
        ...
        className="heritage-band pointer-events-none absolute left-[-8%] right-[-8%] top-1/2 h-[min(480px,65vw)] -translate-y-1/2"
      />
          ...
          <div className="grid items-end gap-10 lg:grid-cols-[minmax(0,1fr)_auto] lg:gap-14">
            <div className="flex flex-col gap-5 sm:flex-row sm:items-end sm:gap-10 md:gap-12">
              ...
              >
                ...
                <motion.span
                  className="absolute -bottom-0.5 left-0 h-0.5 rounded-full bg-gradient-to-r from-primary to-accent/80"
                  initial={{ width: 0 }}
