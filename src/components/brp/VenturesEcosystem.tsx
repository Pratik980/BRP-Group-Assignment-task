...
function VentureDetailPanel({
  ...
  return (
    <motion.article
      ...
      className="relative flex h-full min-h-[420px] flex-col overflow-hidden rounded-[2rem] border border-border/50 bg-card shadow-float md:min-h-[480px] md:rounded-[2.25rem]"
    >
